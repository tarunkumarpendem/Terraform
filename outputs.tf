...
output "launch_template_id" {
  value = aws_launch_template.lb_launch_template.id
}

# asg id's
output "asg-name-1" {
  value = aws_autoscaling_group.lb-asg.id
}

# asg attachment id
output "asg_attachmnet_id" {
  value = aws_autoscaling_attachment.lb_asg_attachment.id
}
